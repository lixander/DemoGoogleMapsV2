...
public class MainActivity extends ActionBarActivity implements LocationListener{
    ...
    public void setUpMap()
    {
        ...
        map1.addMarker(((new MarkerOptions().position((latLng)).title("find me here").snippet("Lalala"))));
    }
    ...
    public void onClick_City(View v)
    {
        ...
        if(vv == null)
        {
            ...
            CameraUpdate update = CameraUpdateFactory.newLatLngZoom(LOCATION_SURREY, 10);
            ...
            //map1.setOnMarkerClickListener(GoogleMap.OnMarkerClickListener);
    ...
    private class SendMessage extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                message = "{\"estadoUsuario\":\"vivo\",\"idUsuario\":2,\"nickName\":\"lixandro\",\"nivelUsuario\":3,\"poderAtaque\":1,\"posUsuario\":\"{\\\"idUsuario\\\":2,\\\"latitud\\\":6.2447470000000003,\\\"longitud\\\":-75.574827999999997}\",\"token\":\"null\",\"vidaMaxUsuario\":100,\"vidaUsuario\":100}";
                ...
                //{"estadoUsuario":"vivo","idUsuario":2,"nickName":"lixandro","nivelUsuario":3,"poderAtaque":1,"posUsuario":"{\"idUsuario":2,\"latitud":6.2447470000000003,\"longitud":-75.574827999999997}","token":"null","vidaMaxUsuario":100,"vidaUsuario":100}
